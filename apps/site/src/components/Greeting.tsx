			...
			{openInstructions ? (
				<Dialog.Root open={openInstructions}>
					...
					<Dialog.Content className="fixed inset-4 lg:inset-y-28 focus:outline-none flex items-center justify-center">
						<div className="flex flex-col max-w-[650px] p-4 bg-black rounded-xl">
							<div className="relative overflow-hidden pt-10 pb-4 px-6 lg:px-[99px] lg:pt-[97px] lg:pb-[40px] text-center flex items-center flex-col bg-body clip-corners">
				...
				<Dialog.Root defaultOpen>
					...
					<Dialog.Content className="fixed inset-4 lg:inset-y-28 focus:outline-none flex items-center justify-center">
						<div className="flex flex-col max-w-[650px] p-4 bg-black rounded-xl">
							<div className="relative overflow-hidden flex items-center justify-center bg-header pb-[31px] pt-[17px] px-4 clip-t-corners">
								<MobileHeader className="w-full max-w-[369px]" />
							</div>
							<div className="bg-orange-main h-5" />
							<div className="bg-yellow-search h-5" />
							<div className="relative overflow-hidden py-6 px-6 lg:px-[50px] lg:pt-[32px] lg:pb-[26px] text-center flex items-center flex-col bg-body clip-b-corners">
